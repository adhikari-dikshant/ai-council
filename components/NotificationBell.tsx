...
export function NotificationBell({ userId }: Props) {
    ...
    return (
        <div className="relative" ref={panelRef}>
            ...
            {open && (
                <div className="absolute right-[-3rem] bottom-10 w-[15.7rem] bg-paper-light border border-line shadow-[0_8px_32px_-4px_rgba(45,31,22,0.15)] rounded-2xl overflow-hidden z-[200]">
